...
public class move2 extends JPanel implements KeyListener, Runnable, ActionListener {
	...
	public void run() {
		...
		while (true) {
			...
			try {
				...
				if(brickNumber == 0) {
					if (JOptionPane.showConfirmDialog(null,"Congratulations! You passed level 2 !!\nLevel 3 incoming...\nScore:220","Well Done",
				...
				if(top.getBounds().intersects(label2.getBounds())) {
					...
					label2_2.setBounds(240, 120, 85, 45);
				...
				if(top.getBounds().intersects(label6.getBounds())) {
					...
					label6_2.setBounds(380, 200, 85, 45);
				...
				if(top.getBounds().intersects(label7.getBounds())) {
					...
					label7_2.setBounds(100, 280, 85, 45);
				...
				if(top.getBounds().intersects(label8.getBounds())) {
					...
					label8_2.setBounds(240, 280, 85, 45);
